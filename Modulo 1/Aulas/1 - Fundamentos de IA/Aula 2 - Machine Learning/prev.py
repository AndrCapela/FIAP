...
print("Previsões do modelo para compostos testados", previsoes)
for i, previao in enumerate(previsoes):
  print(f'O composto {i+1} pode ser considerado {mapeamento_previsoes[previao]}')